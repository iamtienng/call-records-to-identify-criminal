== Call Records To Identify Criminal: Quick Start
Inspired be Neo4j Movies Application
=== The Stack
...
Get yourself setup with link:http://docs.python-guide.org/en/latest/dev/virtualenvs/[virtualenv] so we don't break any other Python stuff you have on your machine. After you've got that installed let's setup an environment for our app:
